package mx.edu.utng.appdiario.ui.screens.cliente.notaTipo.notaTipoPersonal
...
@Composable
fun NotaTipoPersonal(navController: NavController) {
    ...
    Column(
        ...
        Row(
            ...
            Icon(Icons.Default.Person, contentDescription = "Personal", tint = Color.Red)
            Text(
                text = "Personal",
                color = Color.Black,
                fontSize = 14.sp,
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    ...
                    .clickable {
                        // Acción para crear nueva nota personal
                        navController.navigate(NavRoutes.CREACION_NOTA_PERSONAL)
                    },
            ...
            notas.forEach { nota ->
                Card(
                    ...
                    Row(
                        ...
                        Row {
                            // Botón Editar
                            IconButton(onClick = { navController.navigate(NavRoutes.CREACION_NOTA_PERSONAL) }) {
                                Icon(
